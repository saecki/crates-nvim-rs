...
impl Diagnostic for Error {
    ...
    fn description(&self, f: &mut impl std::fmt::Write) -> std::fmt::Result {
        ...
        match self {
            ...
            ExpectedNewlineFound(_) => write!(f, "Unexpected characters, expected a line break"),
